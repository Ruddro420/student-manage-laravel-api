...
class StudenController extends Controller
{
    ...
    public function totalAssingmentNumber($courseName, $batchNo)
    {
        // Get student details and individual ex_1 scores
        $students = SubmitAssingment::where('c_name', $courseName)
            ->where('batch_no', $batchNo)
            ->orderBy('ex_1', 'asc') // optional sorting by ex_1
            ->get();

        // Calculate the total sum of ex_1
        $total = $students->sum('ex_1');
